...
import { useFetchUser } from '../hooks/useFetchUser';
const formatCurrency = require('format-currency');
>>>>>>> 00fcc4957df469f1941bef103726e136dd40789d
            ...
            <div className='background h-screen'>
                ...
                <form className='transaction-form w-11/12 my-0 mx-auto mt-4 mb-16 sm:w-11/12 sm:mt-40 sm:mb-72 md:w-8/12 lg:w-4/12 xl:mt-10 xl:mb-10  shadow-lg p-5 sm:px-6 lg:px-8 ml-6/12 bg-white rounded-lg'>
                    <div className='flex justify-between mb-2'>
                        <ArrowLeftOnRectangleIcon
                            onClick={handleLogout}
                            className=' h-9 w-9 cursor-pointer mr-2 text-red-500'
                            aria-hidden='true'
                        />
                        <Link to={'/history'}>
                            <ClipboardDocumentIcon
                    ...
                    {showInputOTP && (
                        <>
                            <label className='italic block text-gray-700 text-md mt-2'>OTP</label>
                            <input
                                ref={OTPRef}
                                required
                                type='text'
