...
export const LoginPage = () => {
    ...
    const sitekey = '6Lc0iZciAAAAACPD-Oi0IL9vsDyu6uUGtYf3IKNb';
        ...
        <>
            <div className='background 2xl:h-screen h-full bg-gradient-to-r from-yellow-300 to-green-400'>
                ...
                <form
                    ...
                    className='login-form my-0 mx-auto lg:mb-56 2xl:mt-64 2xl:mb-64 mt-12 mb-6 w-11/12 sm:mt-64 sm:mb-40 md:mb-72 lg:mt-20 md:mt-64 sm:w-11/12 md:w-6/12 lg:w-3/12 xl:w-4/12 2xl:w-3/12 shadow-lg p-5 ml-6/12 bg-white rounded-lg'
                >
                    ...
                    <br />
                    <ReCAPTCHA sitekey={sitekey} onChange={() => setIsHuman(true)} />
                    {!isChecked && <i className='text-red-600'>Please verify that you are a human</i>}
                    <button
                        type='submit'
                        className='bg-green-600 mt-3 w-full px-6 p-2 rounded-md text-white font-bold transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-105 hover:bg-green-700 duration-300'
                    >
                        {' '}
                        Log In{' '}
                    </button>
