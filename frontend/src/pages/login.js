        ...
        <>
            <div className="background 2xl:h-screen h-full bg-gradient-to-r from-yellow-300 to-green-400">
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="bg-green-600 w-full px-6 p-2 rounded-md text-white font-bold transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-105 hover:bg-green-700 duration-300"
                    >
                        {' '}
                        Log In{' '}
                    </button>
