    ...
    return (
        <>
            <div className='background pb-4 2xl:h-screen h-full bg-gradient-to-r from-yellow-300 to-green-400'>
                <div className=' px-2 py-6 mb-8 my-0 mx-auto w-11/12 rounded-b-lg bg-white xl:w-2/12 lg:w-4/12 md:w-4/12 sm:w-full shadow-lg'>
                ...
                <div className='w-11/12 p-4 mt-4 sm:w-11/12 md:w-8/12 lg:w-6/12 2xl:w-4/12 my-0 mx-auto '>
                    <Link to='/transaction'>
                ...
                <div className='w-11/12 overflow-auto mt-10 scrollbar-thin scrollbar-thumb-white scrollbar-track-green-600 h-3/4 p-4 sm:w-11/12 md:w-8/12 lg:w-6/12 2xl:w-4/12 my-0 mx-auto '>
                    {isLoading ? (
                        <Spinner />
                    ) : (
                        history &&
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className='font-bold text-xl'>
                                        Execution time: {moment(item.createdAt).format(`MMMM Do YYYY, h:mm a`)}
                                    </p>
