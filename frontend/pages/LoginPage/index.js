        ...
        <>
            <div className='background lg:h-full h-screen bg-gradient-to-r from-yellow-300 to-green-400'>
                ...
                <form className='login-form my-0 mx-auto lg:mb-56 xl:mt-64 xl:mb-64 mt-12 mb-6 w-11/12 sm:mt-64 sm:mb-40 md:mb-72 lg:mt-20 md:mt-64 sm:w-11/12 md:w-6/12 lg:w-3/12 shadow-lg p-5 ml-6/12 bg-white rounded-lg'>
                    ...
                    <label for='username' className='block mt-3 text-gray-700 text-md font-bold mb-1'>
                        Username
                    </label>
                    <input
                        required
                    ...
                    />
                    <label for='password' className='block text-gray-700 text-md font-bold mb-1'>
                        Password
                    </label>
                    <input
                        required
                    ...
                    >
                        ...
                        <div>
                            <span class='font-medium'>Error!</span> Username or password invalid
                        </div>
                    </div>
                    <p>
                        <input required type='checkbox' class='rounded text-blue-500' /> I accept with{' '}
